...
class EvenementGenererCommandFactory extends Command
{
    /**
     ...
     */
    public function __invoke(ContainerInterface $container): EvenementGenererCommand
    {
        $command = new EvenementGenererCommand();
        /**
